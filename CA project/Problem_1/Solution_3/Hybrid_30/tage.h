...
#define BIMODAL_SIZE 104857
#define LEN_BIMODAL 2
#define BIMODAL_INDEX(pc) (pc % BIMODAL_SIZE)

#define LEN_GLOBAL 13
#define LEN_TAG 15
#define LEN_COUNTS 3
#define MIN_HISTORY_LEN 10
#define MAX_HISTORY_LEN 255

// i = 0 ... NUM_BANKS - 1
// geo_i = (int) (MIN_LEN * ((MAX_LEN / MIN_LEN) ^ (i / (NUM_BANKS - 1))) + 0.5)
const uint8_t GEOMETRICS[NUM_BANKS] = {255, 87, 29, 10};
...
uint8_t tage_predict_branch(uint32_t pc){
